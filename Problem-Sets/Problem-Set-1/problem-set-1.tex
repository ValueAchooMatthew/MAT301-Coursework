...
\begin{solution}
	First, we must actually determine $\mathbb{Z^{\times}}_{36}$. We know by part b.) of this problem (the instructor is allowing us to use part b.) to solve part a.)) that: \\
	...
	Thus, $\mathbb{Z^{\times}}_{36} = \set{1, 5, 7, 11, 13l, 17, 19, 23, 25, 29, 31, 35}$ giving a multiplication table of:
